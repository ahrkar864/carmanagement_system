...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="py-8 px-4 sm:px-10 border-cyan-600 ">
        <div class="sm:flex sm:items-center sm:justify-between">
            <div class="sm:flex ">
            <h1 class="text-xl font-semibold text-gray-900">Postions</h1>
            </div>
        ...
        <div class="mt-8 flex flex-col px-4 sm:px-6 lg:px-8">
            <div class="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
                <table class="min-w-full d-table border-separate border-spacing-y-2" id="positionsTable">
                    ...
                    <tr class="h-10">
                        ...
                        <th scope="col" class="border-b border-gray-300  bg-opacity-75 py-2 pl-4 pr-3 text-left text-sm font-semibold text-white backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">Department</th>
                        ...
                        @foreach($positions as $key => $position)
                            <tr class="shadow-lg rounded-full ">
                                ...
                                <td class="border-r-2 rounded-lg border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">
                                    <div class="flex">
                                    <a data-id="{{ $position->id }}" class="editModal inline-flex items-center justify-center rounded-md border border-transparent bg-yellow-50 p-2 text-sm font-bold shadow-md hover:bg-yellow-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto mr-2" >
                                    ...
                                    <a data-id="{{ $position->id }}" data-url="{{ route('positions.destroy', $position->id) }}" class="deleteModal inline-flex items-center justify-center rounded-md border border-transparent bg-rose-50 p-2 text-sm font-bold shadow-md hover:bg-rose-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:w-auto mr-2">
...
<div class="hidden relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="positionModal"
                ...
                <div class="card border border-cyan-700 rounded ">
                    <div class="card-header border-b-2">
                        <div class="flex px-4 py-2 justify-between items-center">
                            <h3 class="font-bold text-cyan-600">Create Position</h3>
                           <button class="text-rose-600 font-extrabold"  onclick="closeModal('#positionModal')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <form class="space-y-4" method="POST" action="" id="formData" enctype="multipart/form-data">
                            ...
                            <div class="mt-2 grid grid-cols-4 gap-4 sm:grid-cols-6">
                                ...
                                <div class="col-span-4 sm:col-span-6">
                                    <label for="branch" class="block text-sm font-medium text-gray-700">Department<span class="required_field">*</span></label>
...
<script src="{{ asset('/js/position_crud.js') }}"></script>
@endsection
