                        ...
                        @foreach($permissions as $key => $permission)
                            <tr class="shadow-lg rounded-full ">
                                ...
                                <td class="border-r-2 rounded-lg border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">
                                    <div class="flex">
                                    <a data-id="{{ $permission->id }}" class="editModal inline-flex items-center justify-center rounded-md border border-transparent bg-yellow-50 p-2 text-sm font-bold shadow-md hover:bg-yellow-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto mr-2" >
                                    ...
                                    <a data-id="{{ $permission->id }}" data-url="{{ route('permissions.destroy', $permission->id) }}" class="deleteModal inline-flex items-center justify-center rounded-md border border-transparent bg-rose-50 p-2 text-sm font-bold shadow-md hover:bg-rose-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:w-auto mr-2">
...
<div class="hidden relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="permissionModal"
                ...
                <div class="card border border-cyan-700 rounded ">
                    <div class="card-header border-b-2">
                        <div class="flex px-4 py-2 justify-between items-center">
                            <h3 class="font-bold text-cyan-600">Create Permission</h3>
                           <button class="text-rose-600 font-extrabold"  onclick="closeModal('#permissionModal')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<script src="{{ asset('/js/permission_crud.js') }}"></script>
