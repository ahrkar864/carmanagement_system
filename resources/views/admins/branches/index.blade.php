...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="py-8 px-4 sm:px-10 border-cyan-600 ">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <button type="button"  data-method="POST" @click="addUser = true" class="inline-flex items-center justify-center rounded-md border border-transparent bg-cyan-600 p-2 text-sm font-bold text-white shadow-md hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 sm:w-auto" id="openModal">
        ...
        <div class="mt-8 flex flex-col px-4 sm:px-6 lg:px-8">
            <div class="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
                <table class="min-w-full d-table border-separate border-spacing-y-2" id="branch_table">
                    ...
                    <tr class="h-10">
                        ...
                        <th scope="col" class="border-b border-gray-300  bg-opacity-75 py-2 pl-4 pr-3 text-left text-sm font-semibold text-white backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">Branch Address</th>                       
                        <th scope="col" class="border-b border-gray-300  bg-opacity-75 py-2 pl-4 pr-3 text-left text-sm font-semibold text-white backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">Branch Phone No</th>   
                    ...
                    <tbody class="bg-white " id="tbody">
                        @foreach ($branches as $key => $branch)
                            <tr class="shadow-lg rounded-full ">
                                ...
                                <td class=" border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">{{ $branch->branch_short_name }}</td>
                                <td class=" border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">{{ $branch->branch_address }}</td>   
                                <td class=" border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">{{ $branch->phone_no }}</td>   
                                <td class="border-r-2 rounded-lg border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">
                                    ...
                                    <a data-id="{{ $branch->id }}" 
                                        class="editModal inline-flex items-center justify-center rounded-md border border-transparent bg-yellow-50 p-2 text-sm font-bold shadow-md hover:bg-yellow-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto mr-2" >
                                    ...
                                    <a data-id="{{ $branch->id}}" data-url="{{ route('branches.destroy', $branch->id) }}" class="deleteModal inline-flex items-center justify-center rounded-md border border-transparent bg-rose-50 p-2 text-sm font-bold shadow-md hover:bg-rose-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:w-auto mr-2">
                            ...
                            <div class="mt-2 grid grid-cols-4 gap-4 sm:grid-cols-6">
                                ...
                                <div class="col-span-4 sm:col-span-6">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" name="branch_code" id="branch_code" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm">
                                    </div>
                                ...
                                <div class="col-span-4 sm:col-span-6">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" name="branch_name" id="branch_name" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm">
                                    </div>
                                ...
                                <div class="col-span-4 sm:col-span-6">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" name="branch_short_name" id="branch_short_name" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm">
                                    </div>
                                ...
                                <!-- Branch Address -->
                                <div class="col-span-4 sm:col-span-6">
                                    <label for="branch_address" class="block text-sm font-medium text-gray-700">Branch Address<span class="required_field">*</span></label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <textarea name="branch_address" id="branch_address" rows="4" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm"></textarea>
                                    </div>
                                    <span class="text-rose-600 error-text" id="branch_addressError" style="font-size: 13px"></span>
                                </div>
                            </div>
