    ...
    <div class="py-8 px-4 sm:px-10 border-cyan-600 ">
        ...
        <div class="mt-8 flex flex-col px-4 sm:px-6 lg:px-8">
            <div class="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
                <table class="min-w-full d-table border-separate border-spacing-y-2" id="usersTable">
                    ...
                    <tbody class="bg-white " id="tbody">
                        @foreach($users as $key => $user)
                            <tr class="shadow-lg rounded-full ">
                                ...
                                <td class="bg-gray-50 bg-opacity-75 py-1 pl-4 pr-3 text-left text-sm font-semibold text-gray-700 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">{{ $user->branch->branch_name }}</td>
                                ...
                                <td class="bg-gray-50 bg-opacity-75 py-1 pl-4 pr-3 text-left text-sm font-semibold text-gray-700 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">{{ $user->employee_number }}</td>
                                ...
                                <td class="border-r-2 rounded-lg border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">
                                    <div class="flex">
                                    <a data-id="{{ $user->id }}" class="editModal inline-flex items-center justify-center rounded-md border border-transparent bg-yellow-50 p-2 text-sm font-bold shadow-md hover:bg-yellow-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto mr-2" >
                                    ...
                                    <a href="{{ route('users.show', $user->id) }}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-cyan-50 p-2 text-sm font-bold shadow-md hover:bg-cyan-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-cyan-600 hover:text-white">
                                    ...
                                    <a data-id="{{ $user->id }}"  
                                        ...
                                        class="deleteModal inline-flex items-center justify-center rounded-md border border-transparent bg-rose-50 p-2 text-sm font-bold shadow-md hover:bg-rose-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:w-auto mr-2">
                            ...
                            <div class="mt-2 grid grid-cols-4 gap-4 sm:grid-cols-6">
                                ...
                                <div class="col-span-3 sm:col-span-3">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <select name="title" id="title" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm py-2">
                                ...
                                <div class="col-span-3 sm:col-span-3">
                                    <label for="name" class="block text-sm font-medium text-gray-700">Email<span class="required_field">*</span></label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="email" name="email" id="email" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm">
                                    </div>
                                    <span class="text-rose-600 error-text" id="emailError" style="font-size: 13px"></span>
                                </div>

                                {{-- employee_number --}}
                                <div class="col-span-3 sm:col-span-3">
                                    <label for="employee_number" class="block text-sm font-medium text-gray-700">Employee Number<span class="required_field">*</span></label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" name="employee_number" id="employee_number" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm">
                                    </div>
                                ...
                                <div class="col-span-3 sm:col-span-3">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="password" name="password" id="password"
                                            class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm">
                                    </div>
                                ...
                                {{-- department --}}
                                <div class="col-span-3 sm:col-span-3">
                                    <label for="department" class="block text-sm font-medium text-gray-700">Department<span class="required_field">*</span></label>
                                    <select name="department_id" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm py-2">
                                        <option value="" disabled selected>Select Department</option>
                                        @foreach($departments as $department)
                                            <option value="{{ $department->id }}">{{ $department->name }}</option>
                                        @endforeach
                                    </select>
                                    <span class="text-rose-600 error-text" id="department_idError" style="font-size: 13px"></span>
                                </div>

                                {{-- position --}}
                                <div class="col-span-3 sm:col-span-3">
                                    <label for="position" class="block text-sm font-medium text-gray-700">Position<span class="required_field">*</span></label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <select name="position_id" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm py-2">
                                    ...
                                    <span class="text-rose-600 error-text" id="position_idError" style="font-size: 13px"></span>
                                </div>
                                ...
                                <div class="col-span-3 sm:col-span-3">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <select name="role_id" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm py-2">
                                ...
                                <div class="col-span-3 sm:col-span-3">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <select name="status" id="status" class="block w-full min-w-0 flex-1 rounded-md shadow border-cyan-600 focus:border-cyan-700 focus:ring-cyan-700 sm:text-sm py-2">
